      ...
      <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">Política de <span className="text-red-500">Privacidade</span></h1>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="mt-12 bg-red-50 rounded-xl border border-red-100 p-8 text-center"
          >
